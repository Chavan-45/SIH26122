...
import { testPlannerRole, testSupervisorRole } from '../services/api';
import Navbar from '../components/Navbar';
import { Calendar, Layers, ShieldCheck, CheckCircle2, AlertTriangle, RefreshCw, UserCheck } from 'lucide-react';
...
export default function PlannerWorkspace() {
  ...
  const handleTestRole = async () => {
    ...
    try {
      const result = await testPlannerRole(token);
      ...
      <main className="workspace-main">
        ...
        <section className="workspace-hero">
          <div className="workspace-title-row">
            ...
            <div>
              <h1 className="workspace-heading">Planner Workspace</h1>
          ...
          <div className="user-meta-strip">
            ...
            <div className="meta-chip">
              ...
              <span className="meta-chip-value role-badge-planner">{user?.role}</span>
            </div>
            <div className="meta-chip">
        ...
        <section className="workspace-notice-card">
          ...
          <div className="notice-content">
            ...
            <p className="notice-text">
              Project creation and schedule management will be available in the next development phase.
            </p>
          </div>
        </section>
        ...
        <section className="workspace-panel-card">
          ...
          <p className="panel-description">
            Test real-time backend authorization for the <code>GET /api/test/planner</code> endpoint using your active JWT token.
          </p>
          ...
          >
            ...
            <span>{isTesting ? 'Verifying RBAC...' : 'Verify Backend Planner Access'}</span>
          </button>
